...
- Invoke plugin skills as `/blueprint:spec`, `/blueprint:plan`, `/blueprint:implement`, `/blueprint:tdd`, `/blueprint:review`, `/blueprint:browser-verify`, `/blueprint:explain-visually`, `/blueprint:compress`, `/blueprint:branch`, or `/blueprint:commit`.
